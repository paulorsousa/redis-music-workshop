...
function uuidv5(name) {
  ...
  const h2 = (hash * 31).toString(16).replace('-', '').padStart(8, '0').slice(0, 8);
  const h3 = (hash * 37).toString(16).replace('-', '').padStart(4, '0').slice(0, 4);
  const h4 = (hash * 41).toString(16).replace('-', '').padStart(4, '0').slice(0, 4);
  const h5 = (hash * 43).toString(16).replace('-', '').padStart(12, '0').slice(0, 12);
